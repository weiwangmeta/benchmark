...
taskset -c "${CORE_LIST}" bash "${CURRENT_DIR}/monitor_proc.sh" python main.py --epochs 1 --model LSTM
# run GPU WLM LSTM
...
taskset -c "${CORE_LIST}" bash "${CURRENT_DIR}/monitor_proc.sh" python main.py --epochs 1 --model LSTM --cuda
...
taskset -c "${CORE_LIST}" bash "${CURRENT_DIR}/monitor_proc.sh" python main.py --epochs 1 --model Transformer
...
taskset -c "${CORE_LIST}" bash "${CURRENT_DIR}/monitor_proc.sh" python main.py --epochs 1 --model Transformer --cuda
